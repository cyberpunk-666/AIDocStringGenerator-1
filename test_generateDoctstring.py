...
class TestDocStringGenerator(unittest.TestCase):
    ...
    #         result_file_path = Path(".", "classTest-result.py")
...
#             mock_keep = APICommunicator.MOCK_RESPONSES_FILE
#             APICommunicator.MOCK_RESPONSES_FILE = str(new_docstrings_response_file_path.absolute())

#             success = FileProcessor(self.config).process_file(new_test_script_file_path, self.config)
#             self.assertTrue(success)
#             APICommunicator.MOCK_RESPONSES_FILE = mock_keep
