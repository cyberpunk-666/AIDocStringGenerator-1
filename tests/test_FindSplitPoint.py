...
class TestFindSplitPoint(unittest.TestCase):
    ...
    def test_normal_code(self):
        ...
        split_point = self.file_processor.find_split_point(source_code, 3)
    ...
    def test_code_with_classes_and_functions(self):
        ...
        split_point = self.file_processor.find_split_point(source_code)
    ...
    def test_long_code_exceeding_max_length(self):
        ...
        source_code += "x = 1\n" * 1000
        split_point = self.file_processor.find_split_point(source_code, max_lines=len("x = 1\n")*1200)
